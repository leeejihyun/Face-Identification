...
__all__ = ['FaceRecognition',
           'arcface_r100_v1', 'arcface_r50_v1', 'arcface_r34_v1', 'arcface_outofreach_v1', 'arcface_mfn_v1',
           'get_arcface']
...
def arcface_r50_v1(**kwargs):
    return get_arcface("r50_v1", download=True, **kwargs)

def arcface_r34_v1(**kwargs):
    return get_arcface("r34_v1", download=True, **kwargs)
